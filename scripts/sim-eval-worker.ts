...
import { DEFAULT_COMPRESSOR_RUN_PARAMS } from '../lib/analytics/episodes/compressor';
import { DEFAULT_ESS_EXTRACTOR_PARAMS } from '../lib/analytics/episodes/ess';
import { DEFAULT_ESS_STEP_PARAMS } from '../lib/analytics/episodes/ess-steps';
import { DEFAULT_FC_BLOWER_RUN_PARAMS } from '../lib/analytics/episodes/fc-blower';
...
import { DEFAULT_TANK_HOLD_PARAMS } from '../lib/analytics/episodes/tank-hold';
import { DEFAULT_WX_DAY_PARAMS } from '../lib/analytics/episodes/wx-day';
import { LEDGER_DEFAULTS } from '../lib/analytics/ledger/params';
...
const cacheKey = (request: WorkerRequest): string =>
  hashInput({
    format: PREPARED_JOB_FORMAT,
    job: request.job,
    extractor: EXTRACTOR_VERSIONS,
    ess: DEFAULT_ESS_EXTRACTOR_PARAMS,
    pv: DEFAULT_PV_DAY_PARAMS,
    stack: DEFAULT_STACK_EXTRACTOR_PARAMS,
    p3: [DEFAULT_ESS_STEP_PARAMS, DEFAULT_COMPRESSOR_RUN_PARAMS, DEFAULT_TANK_HOLD_PARAMS, DEFAULT_FC_BLOWER_RUN_PARAMS, DEFAULT_WX_DAY_PARAMS, LEDGER_DEFAULTS],
  }).slice(0, 12);
