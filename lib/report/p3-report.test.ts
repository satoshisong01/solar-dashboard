...
describe('P3 탐지기 8종 메시지 템플릿', () => {
  ...
  it('저장용기 누설: 구간 수·온도 보정 질량 감소·95% CI·유의 기준·안전 기준과 현장 확인·대체 불가 문구', () => {
    expect(textOf(draft, 'finding.10.message')).toBe(
      '[SIM-B/H2BANK1/TANK3] 저장용기 정지 보유 누설 (확정, 신뢰도 70%·탐지 3회): 정지 보유 구간 4개(길이 중앙값 9 h)의 온도 보정 질량(NIST 상태식)이 하루 1.03 kg(95% CI 0.98 ~ 1.07) 감소했습니다. 하루 저장량의 2.61%입니다. ' +
        '기준 구간 4개로 잰 센서 잡음 수준(σ 0.069 kg/일)의 유의 기준 0.084 kg/일을 넘습니다. 누설률 95% CI 하한이 안전 기준 0.5 kg/일을 넘는 안전 발견사항입니다. 가스 검지기 기록 확인과 누설 점검을 즉시 진행하고, 운전 정지 여부는 현장 안전책임자가 판단하세요. ' +
