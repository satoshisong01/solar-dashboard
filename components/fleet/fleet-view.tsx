...
const TOGGLE_CLASS =
  'inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm font-medium text-ink-2 max-lg:min-h-11 hover:text-ink ' +
  'aria-pressed:bg-hydrogen-fill aria-pressed:text-ink aria-pressed:shadow-glow';
